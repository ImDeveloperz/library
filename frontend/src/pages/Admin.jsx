...
import {
    ...
    Chip,
    User,
    Pagination, useDisclosure, ModalContent, Modal, ModalBody, ModalFooter, ModalHeader, Tooltip,
...
const Admin = (props) => {
    ...
    const supprimer = async (id) => {
        try{
            const response = await axios.delete('/bibliothecaire?id='+id,{
                headers:{
                    "Authorization" : "Bearer " + auth.token
                }
            });
            ...
            case "actions":
                return (
                    <div className="relative text-black flex justify-end items-center gap-2">
                        <Tooltip color="danger" size="sm" content="Supprimer">
                            <div className="cursor-pointer ">
                                <MdDelete className="text-red-500 text-xl " onClick={
                                    ()=>{
                                        supprimer(user.id).then(r => r).catch(e => e);
                                    }
                                }/>
                            </div>
                        </Tooltip>
